...
public class ProdutoAlimento extends Produto {
    ...
    public ProdutoAlimento(String nomeProduto, String marcaProduto, String categoriaProduto, int codProduto, int quantidadeProduto, float precoProduto, float pesoAlimento) {
